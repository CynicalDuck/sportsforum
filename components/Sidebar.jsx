...
const Sidebar = (props) => {
  ...
  return (
    <div className="bg-gray-200 px-4 py-4 text-[0.7rem] border-r-[1px] border-gray-300 min-h-screen h-[100%]">
        ...
        <div className="flex flex-col gap-3">
          <div className="group flex flex-row gap-1 hover:bg-indigo-500 rounded-[10px]">
            <div className="bg-gray-100 rounded-[10px] py-2 px-2 group-hover:bg-indigo-500">
              <FontAwesomeIcon
                icon={faHome}
                className="text-gray-500 text-[0.7rem] group-hover:text-white group-hover:cursor-pointer"
              />
            </div>
            <a
              href="/"
          ...
          >
            ...
            <a className="text-gray-500 text-[0.7rem] py-2 px-2 group-hover:text-white group-hover:cursor-pointer group-hover:bg-indigo-500">
              Dine tråder
            </a>
          </div>
          {showUserDiscussions ? (
            <div className="flex flex-col gap-1 px-7">
              {userDiscussions?.map((discussion, index) => {
                return (
                  <div
                    key={index}
                    className="group bg-gray-200 text-gray-500 rounded-[10px] px-2 py-2 hover:bg-indigo-500 hover:text-white hover:cursor-pointer capitalize text-[0.7rem]"
                    onClick={() => {
          ...
          >
            ...
            <a className="text-gray-500 text-[0.7rem] py-2 px-2 group-hover:text-white group-hover:cursor-pointer">
              Lagrede tråder{" "}
